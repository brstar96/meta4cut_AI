...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--checkpoint_path", default='./models/chilloutmix/vae/diffusion_pytorch_model.ckpt', type=str, required=True, help="Path to the checkpoint to convert."
    )
    ...
    parser.add_argument("--dump_path", default='./temp', type=str, required=True, help="Path to the output model.")
