"""
https://github.com/haofanwang/Lora-for-Diffusers/blob/main/format_convert.py
...
if __name__ == "__main__":
    ...
    safetensor_path = "/projects/meta4cut_BE/models/Lora/koreanDollLikeness_v15/koreanDollLikeness_v15.safetensors"
    os.makedirs("./temp", exist_ok=True)
    bin_path = "./temp/pytorch_lora_weights.bin"
