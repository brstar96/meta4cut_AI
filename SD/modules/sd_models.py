...
import paths, shared, modelloader, devices, script_callbacks, sd_vae, sd_disable_initialization, errors, hashes, sd_models_config
from paths import models_path
from sd_hijack_inpainting import do_inpainting_hijack
from timer import Timer

model_dir = "Stable-diffusion/Chilloutmix"
...
def list_models():
    ...
    model_list = modelloader.load_models(model_path=model_path, model_url=model_url, command_path=shared.cmd_opts.ckpt_dir, ext_filter=[".ckpt", ".safetensors"], download_name=None, ext_blacklist=[".vae.ckpt", ".vae.safetensors"]) # "v1-5-pruned-emaonly.safetensors"
